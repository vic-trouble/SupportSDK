  ...
  */
  ...
  class ObjectSettings
    ...
    public:
      ...
      GAMECORE_EXPORT ObjectSettings (int i_type, const tinyxml2::XMLElement& i_object_node, const IObjectComposer& i_composer);
      GAMECORE_EXPORT ~ObjectSettings();

      GAMECORE_EXPORT void Initialize(int i_type, const tinyxml2::XMLElement& i_object_node);
