...
namespace SDK
{
	...
	namespace Math
	{
		...
		template <typename CoordinateType, size_t Dimension>
		Vector<CoordinateType, Dimension> Vector<CoordinateType, Dimension>::operator + (const Vector<CoordinateType, Dimension>& i_other) const
		{
			Vector<CoordinateType, Dimension> res = *this;
			res += i_other;
			return res;
		}
		...
		template <typename CoordinateType, size_t Dimension>
		Vector<CoordinateType, Dimension> Vector<CoordinateType, Dimension>::operator - () const
		{
			Vector<CoordinateType, Dimension> res;
			for (size_t i = 0; i < Dimension; ++i)
				res[i] = -m_vertices[i];
			return res;
		}
		...
		template <typename CoordinateType, size_t Dimension>
		Vector<CoordinateType, Dimension> Vector<CoordinateType, Dimension>::operator * (CoordinateType i_multiplyer) const
		{
			Vector<CoordinateType, Dimension> res = *this;
			res *= i_multiplyer;
			return res;
